...
//		this.stats.showTopSpam(this.TOP_N);
	...
	public double readHamKalibration(Stats stats) throws IOException
	{
		...
		for(File mail:mails)
		{
			...
			double hamProbability = stats.calcHam(topWords);
		...
		System.out.println("CALIBRATION (HAM): " + counter +" out of " + mails.length +" were classfied correctly as ham. -> " + percent +"%");
	...
	public double readSpamKalibration(Stats stats) throws IOException
	{
		...
		for(File mail:mails)
		{
			...
			double spamProbability = stats.calcSpam(topWords);
		...
		System.out.println("CALIBRATION (SPAM): " + counter +" out of " + mails.length +" were classfied correctly as spam. -> " + percent +"%");
	...
	public void readHamTest(Stats stats) throws IOException
	{
		...
		System.out.println("TEST (HAM): " + counter +" out of " + mails.length +" were classfied correctly as ham. -> " + percent +"%");
	...
	public void readSpamTest(Stats stats) throws IOException
	{
		...
		System.out.println("TEST (SPAM): " + counter +" out of " + mails.length +" were classfied correctly as spam. -> " + percent +"%");
...
//			System.out.println("calib ham " + counter + " delta: " + delta +" epsilon: " + epsilon);
			
			counter++;
		}
		
//		System.out.println("Delta>e: " + delta +" > " + epsilon + " counter<max_it: " + counter + "<" + this.MAX_CALIBRATION_ITERATIONS);
